...
namespace Overlay.NET.Directx
{
    ...
    public class Direct2DRenderer
    {
        ...
        ///     The GDI transparent
        /// </summary>
        static Color _gdiTransparent = Color.Transparent;

        /// <summary>
        ///     The transparent
        /// </summary>
        static readonly RawColor4 Transparent = new RawColor4(_gdiTransparent.R, _gdiTransparent.G, _gdiTransparent.B,
            _gdiTransparent.A);
        ...
        ///     The device
        /// </summary>
        readonly WindowRenderTarget _device;
        ...
        ///     The font factory
        /// </summary>
        readonly Factory _fontFactory;

        /// <summary>
        ///     The brush container
        /// </summary>
        List<SolidColorBrush> _brushContainer = new List<SolidColorBrush>(32);
        ...
        ///     The font container
        /// </summary>
        List<TextFormat> _fontContainer = new List<TextFormat>(32);

        /// <summary>
        ///     The layout container
        /// </summary>
        List<TextLayoutBuffer> _layoutContainer = new List<TextLayoutBuffer>(32);
